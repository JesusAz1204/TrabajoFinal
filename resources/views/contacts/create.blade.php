...
<div class="container max-w-xl p-4 mx-auto">
    <h1 class="mb-4 text-2xl font-bold">Registro de Nuevo Contacto</h1>
    <p class="mb-6 text-gray-600">Añade la información de tu nuevo contacto.</p>

    <form action="{{ route('contacts.store') }}" method="POST" class="p-6 bg-white rounded-lg shadow-md">
        @csrf
        ...
        <div class="flex items-center justify-between">
            ...
            <button type="submit" class="px-4 py-2 font-bold text-white bg-green-600 rounded hover:bg-green-700 focus:outline-none focus:shadow-outline">
                Guardar Contacto
            </button>
        </div>
    </form>
